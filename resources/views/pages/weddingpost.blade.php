...
<!-- Mirrored from duruthemes.com/demo/html/pwe/multipage//weddingpost by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Mar 2024 10:26:58 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div id="pwe-page"> 
        ...
        <div id="pwe-main">
                ...
                <div class="banner-head">
                    <div class="banner-head-padding banner-head-margin">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12"> <span class="heading-meta">.reception</span>
                                    <h2 class="pwe-heading animate-box" data-animate-effect="fadeInLeft">Dance Party Begins</h2>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="post-section pt-0 pb-60">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 image-content animate-box" data-animate-effect="fadeInLeft"> <img src="{{ asset('images/blog/2.webp') }}" class="img-fluid mb-30" alt=""> </div>
                    </div>
                    <div class="row">
                                    ...
                                    <ol class="comment-list">
                                        <li class="comment">
                                            <div class="comment-body">
                                                <div class="comment-author vcard"> <img class="avatar photo" src="{{ asset('images/blog/people01.webp') }}" alt="">
                                                    <h3 class="name">Peter Berry</h3>
                                                </div>
                                                <div class="comment-meta"> Sep 28, 2023 </div>
                                                <p>Yuroin non lorem ac erat suscipit bibendum. Nulla facilisi. Sedeuter nunc volutpat, mollis sapien veli, conseyer turpeutionyer massa in libero semper sedeuter nunc volutpat, mollis sapien veletion. Quisque gravida eros ut turpis interdum ornare. Interdum et malesu they adamale fames ac ante ipsum primis in faucibus. Curabitur arcu erosite feugiat in tortor in, volutpat sollicitudin libero.</p>
                                            ...
                                            <ol class="children">
                                                <li class="comment odd parent">
                                                    <div class="comment-body">
                                                        <div class="comment-author vcard"> <img class="avatar photo" src="{{ asset('images/blog/people02.webp') }}" alt="">
                                                            <h3 class="name">Lena Glenn</h3>
                                                        </div>
                                                        <div class="comment-meta"> Sep 27, 2023 </div>
                                        ...
                                        <li class="comment">
                                            <!-- comment block -->
                                            <div class="comment-body">
                                                <div class="comment-author vcard"> <img class="avatar photo" src="{{ asset('images/blog/people04.webp') }}" alt="">
...
<!-- Mirrored from duruthemes.com/demo/html/pwe/multipage//weddingpost by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Mar 2024 10:26:59 GMT -->
</html>
